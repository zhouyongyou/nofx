...
NOFX 是一个处理真实资金和 API 凭证的 AI 交易系统。我们非常重视安全，并感谢安全社区负责任地披露安全问题的努力。
...
| **初步评估** | 72 小时 | 验证问题，评估严重程度 |
| **修复开发** | 7-30 天 | 取决于复杂性和严重程度 |
| **测试** | 3-7 天 | 验证修复不会破坏功能 |
| **公开披露** | 修复部署后 | 发布安全公告 |

**严重安全问题**（资金盗窃、凭证外流）会优先处理，可能在 48 小时内修复。
