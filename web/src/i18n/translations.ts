...
export const translations = {
  en: {
    ...
    promptTemplateAdaptiveModerate: 'Balanced Strategy',
    promptTemplateAdaptiveRelaxed: 'Aggressive Strategy',
    promptTemplateAdaptiveAltcoin: 'Altcoin Specialist',
    ...
    promptDescAdaptiveModerate: '⚖️ Balanced Strategy (v6.0.0)',
    promptDescAdaptiveModerateContent: 'Balance risk control and frequency, BTC recommended confirmation, suitable for regular markets',
    ...
    promptDescAdaptiveAltcoin: '🪙 Altcoin Specialist (v6.0.0)',
    promptDescAdaptiveAltcoinContent: 'Focus on altcoin trading, BTC reference only without blocking positions, suitable for Altcoin trading',
  ...
  zh: {
    ...
    promptTemplateAdaptiveModerate: '平衡策略',
    promptTemplateAdaptiveRelaxed: '激进策略',
    promptTemplateAdaptiveAltcoin: '山寨币专用',
    ...
    promptDescAdaptiveModerate: '⚖️ 平衡策略 (v6.0.0)',
    promptDescAdaptiveModerateContent: '平衡风控与频率，BTC 建议确认，适合常规市场环境',
    promptDescAdaptiveRelaxed: '⚡ 激进策略 (v6.0.0)',
    promptDescAdaptiveRelaxedContent: '高频交易，BTC 可选确认，追求交易机会，适合波动市场',
    promptDescAdaptiveAltcoin: '🪙 山寨币专用 (v6.0.0)',
    promptDescAdaptiveAltcoinContent: '专注山寨币交易，BTC 仅作参考不阻止开仓，适合 Altcoin 交易',
